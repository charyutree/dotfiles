...
;prefer newer byte compiled packages
...
(custom-set-variables
 ...
 '(org-contacts-files '("~/Dropbox/org-files/contacts.org"))
 '(package-selected-packages
   '(evil-org color-theme-sanityinc-tomorrow monokai-pro-theme hc-zenburn-theme gruvbox-theme solarized-theme org-super-agenda powershell orgtbl-ascii-plot jedi use-package helm magit pyenv-mode material-theme exec-path-from-shell elpy better-defaults))
